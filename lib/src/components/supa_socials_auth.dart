...
extension on OAuthProvider {
  IconData get iconData => switch (this) {
        ...
        OAuthProvider.kakao => FontAwesomeIcons.comment.data,
        OAuthProvider.keycloak => FontAwesomeIcons.key.data,
        OAuthProvider.linkedin => FontAwesomeIcons.linkedin.data,
        OAuthProvider.notion => FontAwesomeIcons.diceD20.data,
        ...
        OAuthProvider.workos => FontAwesomeIcons.building.data,
        _ => Icons.error,
      };
